...
/** @typedef {{ settings?: any }} EnvSyncSecretStoreContext */

/**
 * @typedef EnvSyncSecretStore
 * @property {(key: string, context: EnvSyncSecretStoreContext) => (string|Promise<string>)} get
 * @property {(key: string, context: EnvSyncSecretStoreContext) => (void|Promise<void>)} [remove]
 * @property {(key: string, value: string, context: EnvSyncSecretStoreContext) => (void|Promise<void>)} [set]
 */
